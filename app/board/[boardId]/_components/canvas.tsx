...
export const Canvas = ({
   boardId,
    ...
    const insertLayer = useMutation((
      ...
      layerType: LayerType.Ellipse | LayerType.Rectangle | LayerType.Triangle | LayerType.Text | LayerType.Note,
      position: Point,
     ...
     const unselectedLayers = useMutation ((
      ...
      if (
        Math.abs(current.x - origin.x) + Math.abs(current.y - origin.y) > 5// How far the mouse moved left/right.
      ) {// How far the mouse moved up/down > 5 If you move less than 5 pixels The code does nothing
        setCanvasState({
          mode: CanvasMode.SelectionNet,
          origin,
          current,
